      ...
      <div class="wrapper">
        ...
        <div class="sidebar-wrapper">
          ...
          <div class="profile-container">
            <img class="profile" src="{{ secure_asset('images/profile-small.png') }}" alt="Profile Image" />
        ...
        <div class="main-wrapper">
          ...
          <section class="download-section section">
            <h2 class="section-title"><i class="fa fa-download"></i><a href="{{ secure_asset('/files/resume.pdf') }}">Download Resume</a></h2>
            <div class="item">
            </div>
          </section>
