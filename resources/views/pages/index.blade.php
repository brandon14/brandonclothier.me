...
<meta property="og:image" content="{{ \Helpers\manifest_asset('images/profile-large.png') }}" />
...
@section('content')
  ...
  @push('scripts')
    <script src="{{ \Helpers\manifest_asset('js/manifest.js') }}"></script>
    <script src="{{ \Helpers\manifest_asset('js/vendor.js') }}"></script>
    <script src="{{ \Helpers\manifest_asset('js/app.js') }}"></script>
